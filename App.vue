...
<style>
	...
	@font-face {font-family: "iconfont";
	  src: url('https://gitee.com/hao_aoran/uniapp_font.git/iconfont.eot?t=1576844226174'); /* IE9 */
	  src: url('https://gitee.com/hao_aoran/uniapp_font.git/iconfont.eot?t=1576844226174#iefix') format('embedded-opentype'), /* IE6-IE8 */
	  ...
	  url('https://gitee.com/hao_aoran/uniapp_font.git/iconfont.woff?t=1576844226174') format('woff'),
	  url('https://gitee.com/hao_aoran/uniapp_font.git/iconfont.ttf?t=1576844226174') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
	  url('https://gitee.com/hao_aoran/uniapp_font.git/iconfont.svg?t=1576844226174#iconfont') format('svg'); /* iOS 4.1- */
	}
